...
const Header = () => {
  ...
  return (
    <div className="absolute w-screen px-8 py-2 md:bg-gradient-to-b from-black z-10 flex flex-col md:flex-row  md:justify-between ">
      ...
      {user && (
        <div className="flex p-2 flex-wrap justify-between">
          ...
          <button className="py-2 px-4 mr-4 h-12 bg-purple-400 text-white rounded-lg" onClick={handleGptSearch}>
            {gptValue ? "Netflix": "GPT Search"}
            </button>
          <img
            className=" hidden md:inline blick w-12 h-12 rounded-md"
            alt="usericon"
            src={user?.photoURL}
          />
